...
#creating forms from created model
...
@login_required
# backend of creating new Listing item
def newListing(request):
    # creating form for picture and assigning as variable 
    ...
    if request.method == "POST":        
        ...
        if form.is_valid() and imagesForm.is_valid():
            ...
            for form in imagesForm.cleaned_data:
                # if its exist, saving to Picture model
                if form:
...
#  listing for listing page 2nd requirement 
